...
export default function CartItem({ imgLink, name }: CartItemProps) {
  return (
    <div className="flex flex-row justify-between">
      ...
      <div className={labelStyle} style={{ width: '240px', paddingTop: '60px' }}>
        ...
        <div style={{ margin: '20px 0' }}>
          <p className={priceStyle}>€10.99</p>
          <p className={discountPriceStyle}>€9.34</p>
        </div>
      </div>
      ...
      <div style={{ paddingTop: '60px' }}>
        <Button text={'Remove disc'} isPrimary={false} addClass="max-h-10 bg-pink-600"></Button>
      </div>
    </div>
  );
}
